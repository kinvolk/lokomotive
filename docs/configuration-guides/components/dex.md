...
- During Service Account creation a JSON file will be downloaded, give the path of this file in
...
Admin SDK lets administrators of enterprise domains to view and manage resources like user, groups
