...
func TestCharatFromManifestsRemoveNamespace(t *testing.T) {
	manifests := map[string]string{
		"namespace.yaml": `
apiVersion: v1
kind: Namespace
...
func TestCharatFromManifestsRemoveNamespaceRetainObject(t *testing.T) {
	manifests := map[string]string{
		"objects.yaml": `
apiVersion: v1
kind: Namespace
...
func TestCharatFromManifestsMoveCRDs(t *testing.T) {
	manifests := map[string]string{
		"crd.yaml": `
