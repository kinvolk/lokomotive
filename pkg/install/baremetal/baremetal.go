...
func Install(cfg *config) error {
	terraformModuleDir := filepath.Join(cfg.AssetDir, "lokomotive-kubernetes/bare-metal")
	if err := install.PrepareLokomotiveTerraformModuleAt(terraformModuleDir, "bare-metal"); err != nil {
		return err
	}
